...
Therefore, this script auto-generates the B-spline coefficients for this Gaussian peak
approximation of the Hermite functions and stores them in the Python file that will then
be available within ``robust_fourier``.
